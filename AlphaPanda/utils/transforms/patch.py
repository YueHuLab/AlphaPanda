...
class PatchAroundAnchor(object):
    ...
    def __call__(self, data):        
        ...
        #huyue
        #print("data patch aa shape\n")
        #print(data_patch["aa"].shape)
        #print("\n")
        #print("data patch attentions shape\n")
        #print(data_patch["attentions"].shape)
        #print("\n")
        #print("data patch representations shape\n")
        #print(data_patch["representations"].shape)
        #print("\n")
        #print("\n")
        #print("\n")
        #print("\n")
        return data_patch
@register_transform('patch_around_anchorAll')
class PatchAroundAnchorAll(object):
