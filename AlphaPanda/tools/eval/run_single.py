...
#huyue
from AlphaPanda.tools.eval.base import EvalTask, TaskScanner
from AlphaPanda.tools.eval.similarity import eval_similarity
from AlphaPanda.tools.eval.energy import eval_interface_energy
...
def main():
   ...
   # ray.init()
   # ray.init(num_cpus=5,object_store_memory=10**9, address='auto') #huyue
    #ray.init(num_cpus=5,object_store_memory=10**9,include_dashboard=True,dashboard_host='0.0.0.0') #huyue
   # ray.init(num_cpus=5,object_store_memory=10**9,include_dashboard=False) #huyue
   # ray.init(num_cpus=5,object_store_memory=10**9,include_dashboard=False) #huyue
    ray.init(num_cpus=5) #huyue
