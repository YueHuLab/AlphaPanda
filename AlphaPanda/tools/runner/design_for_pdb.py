...
from AlphaPanda.datasets.custom import preprocess_antibody_structure
...
from AlphaPanda.tools.renumber import renumber as renumber_antibody
#
...
def design_for_pdb(args):
    ...
    print("data seq \n")
    print(structure_['heavy'])
    print("\n")
    print("data seq  heavy seqmap\n")
    print(structure_['heavy_seqmap'])
    print("\n")
...
def args_from_cmdline():
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=6) # huyue defalut 16
