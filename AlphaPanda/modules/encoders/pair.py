...
from AlphaPanda.modules.common.geometry import angstrom_to_nm, pairwise_dihedrals
...
class PairEmbedding(nn.Module):
    ...
    #def __init__(self, feat_dim, max_num_atoms, esm_pair_dim=660, max_aa_types=22, max_relpos=32):
    def __init__(self, feat_dim, max_num_atoms, max_aa_types=22, max_relpos=32):
        super().__init__()
        self.max_num_atoms = max_num_atoms
        self.max_aa_types = max_aa_types
        self.max_relpos = max_relpos
        #self.esm_pair_dim= esm_pair_dim
        ...
        #infeat_dim = feat_dim+feat_dim+feat_dim+feat_dihed_dim+self.esm_pair_dim
    ...
    #def forward(self, aa, res_nb, chain_nb, pos_atoms, mask_atoms, esm_pair_feat, structure_mask=None, sequence_mask=None):
    def forward(self, aa, res_nb, chain_nb, pos_atoms, mask_atoms, structure_mask=None, sequence_mask=None):
        ...
        # All
        #feat_all = torch.cat([feat_aapair, feat_relpos, feat_dist, feat_dihed, esm_pair_feat], dim=-1)
