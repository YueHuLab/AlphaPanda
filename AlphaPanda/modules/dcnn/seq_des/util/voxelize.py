...
def voxelize(x, x_data, n=20, c=14, dist=10, plot=False, bb_only=0): #huyue 15 atomtypes
    ...
    if not bb_only:
        ...
        output = np.concatenate([output_atom[:, :c], output_bb[:, :1], output_res[:, :20]], 1) # huyue
    else:
...
def get_voxel_idx(x, x_data, n=20, c=14, dist=10, plot=False): # huyue 15 atomtypes
