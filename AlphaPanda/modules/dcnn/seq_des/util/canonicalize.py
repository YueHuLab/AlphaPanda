...
def batch_canonicalize_coords(atom_coords, atom_data, residue_bb_index_list, res_idx=None, num_return=400, bb_only=0):
    ...
    vector_x_back=x_idxN - x_idxCA #huyue
    x = f_bR(x)
    ...
    #print(x_idxCB)
    #print('x_idxCB \n in canon\n')
    back_f_R, back_f_bR = get_batch_N_CA_C_align_back(normal, r=n_res, n=n) 
    #print('x_idxN \n in canon back \n')
    #print(back_f_R(x_idxN))
    #print('x_idxN \n in canon\n')
    #print('x_idxCA \n in canon back \n')
    #print(back_f_R(x_idxCA))
    #print('x_idxC \n in canon\n')
    #print('x_idxC \n in canon back \n')
    #print(back_f_R(x_idxC))
    #print('x_idxC \n in canon\n')
    #print('x_idxCB \n in canon bakc\n')
    #print(back_f_R(x_idxCB))
    #print('x_idxCB \n in canon\n')
    x = f_bR(x)
    ...
    return x, x_data, center, fixed_CB,x_idxN, x_idxC, x_idxCA,x_idxCB,vector_x_back,vector_z_normal_back,n_res,n
